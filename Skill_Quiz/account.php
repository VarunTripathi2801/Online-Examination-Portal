...
<title>Skill Quiz || Account</title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Skill Quiz</span></div>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Skill Quiz</b></a>
    </div>
...
<a href="about_us.php" target="#developers">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Developer Namr" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:14px" title="Find on Facebook">Dinesh Kumar Yadav & Eram Yasmeen</a>
		<h6 style="color:#202020; font-family:'typo' ;font-size:12px" class="title1">+91-7355046722 / +91-7355046722</h6>
		<h4 style="font-family:'typo' ">skillquiz@gmail.com</h4>
		<h4 style="font-family:'typo' ">Integral University, Lucknow, U.P</h4></div></div>
		</p>
      </div>
